---
title: "MY472 - Week 5: Seminar exercises in scraping unstructured data"
...
bribe_nodes <- html_elements(bribe_html, css = "____________")
...
```{r}
transaction <- html_elements(bribe_html, "____________________") %>% 
  html_text
...
scrape_bribe <- function(url){
  ...
  transaction <- html_elements(c_html, "_______________") %>% 
    html_text
